// 🌐 Worker API base URL
const API_BASE = "https://gptapi-proxy.barney-willis2.workers.dev"; // ⬅️ replace with your Worker URL
...
sendBtn.addEventListener("click", async () => {
  ...
  try {
    const response = await sendMessage("gpt-5", currentChat.messages);
